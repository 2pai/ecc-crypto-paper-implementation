...
const decrypted1 = decrypt(deserialized,privateKey)

const dcd = decode(decrypted)
const dcd1 = decode(decrypted1)
console.log(dcd1)
// const the = ec.curve.point(new BN('ab62d30f867eb511b22f8af112629a5bba620606bb1f0bd85e40d35d885b0f6d',16),new BN('ab62d30f867eb511b22f8af112629a5bba620606bb1f0bd85e40d35d885b0f6d',16))
// console.log(the)